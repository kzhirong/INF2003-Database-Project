                      ...
                      <tr key={cca._id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <div className="flex items-center justify-end gap-2">
                            <Link href={`/admin/ccas/${cca._id}`}>
                              <button className="inline-flex items-center gap-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-semibold rounded-lg transition-colors cursor-pointer">
                                <svg 
                                  width="16" 
                                  height="16" 
                                  viewBox="0 0 24 24" 
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-4 py-2 bg-[#F44336] hover:bg-[#D32F2F] text-white text-sm font-semibold rounded-lg transition-colors cursor-pointer"
                            >
                              <svg 
                                width="16" 
                                height="16" 
